...
export class MetadataCollector {
  ...
  public getMetadata(sourceFile: ts.SourceFile, strict: boolean = false): ModuleMetadata {
    ...
    function classMetadataOf(classDeclaration: ts.ClassDeclaration): ClassMetadata {
      ...
      function getDecorators(decorators: ts.NodeArray<ts.Decorator>): MetadataSymbolicExpression[] {
      ...
      switch (node.kind) {
        case ts.SyntaxKind.ClassDeclaration:
          ...
          if (classDeclaration.name) {
            ...
            if (isExported(classDeclaration)) {
              locals.define(
                  className, <MetadataValue>{__symbolic: 'reference', name: exportedName(classDeclaration)});
            } else {
              locals.define(
        ...
        case ts.SyntaxKind.InterfaceDeclaration:
          ...
          if (interfaceDeclaration.name) {
            ...
            locals.define(interfaceName, <MetadataValue>{__symbolic: 'reference', name: 'any'});
          }
          break;
          ...
          if (isExported(enumDeclaration)) {
            ...
            for (const member of enumDeclaration.members) {
              ...
              if (typeof enumValue === 'number') {
                ...
                nextDefaultValue = <MetadataValue>{
                  __symbolic: 'binary',
                  operator: '+',
                  left: {
                    __symbolic: 'select',

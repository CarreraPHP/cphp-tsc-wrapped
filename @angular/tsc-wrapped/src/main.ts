...
export function main(
  ...
  try {
    ...
    const basePath = path.resolve(process.cwd(), <string>(cliOptions.basePath || projectDir));
    ...
    let host = <ts.CompilerHost>ts.createCompilerHost(parsed.options, true);
    ...
    const tsickleCompilerHostOptions = {googmodule: false, untyped: true, convertIndexImportShorthand: false};

    const tsickleHost: tsickle.TsickleHost = <tsickle.TsickleHost>{
